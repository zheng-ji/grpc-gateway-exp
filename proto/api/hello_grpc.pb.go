...
func (c *helloServiceClient) Hello(ctx context.Context, in *HelloMessage, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc_gateway_exp.HelloService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_gateway_exp.HelloService/Hello",
	}
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_gateway_exp.HelloService",
