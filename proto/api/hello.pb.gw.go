...
/*
Package grpc_gateway_exp is a reverse proxy.
...
var (
	pattern_HelloService_Hello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"hello"}, "", runtime.AssumeColonVerbOpt(true)))
)
